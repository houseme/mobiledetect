...
var (
	phoneDevices = [...]string{
		...
		// NEXUS:
		`Nexus One|Nexus S|Galaxy.*Nexus|Android.*Nexus.*mobile|Nexus 4|Nexus 5|Nexus5X|Nexus 6`,
		...
		`(?is)^(?!.*\bx11\b).*xiaomi.*$|POCOPHONE F1|\bMI\b 8|\bMi\b 10|Redmi Note 9S|Redmi 5A|Redmi Note 5A Prime|Redmi Note 7 Pro|N2G47H|M2001J2G|M2001J2I|M1805E10A|M2004J11G|M1902F1G|M2002J9G|M2004J19G|M2003J6A1G|M2012K11C`,
		// NOKIA:
		`Lumia [0-9]{3,4}`,
	...
	tabletDevices = [...]string{
		...
		// ASUSTABLET:
		`^.*PadFone.*$|Transformer|TF101|TF101G|TF300T|TF300TG|TF300TL|TF700T|TF700KL|TF701T|TF810C|ME171|ME301T|ME302C|ME371MG|ME370T|ME372MG|ME172V|ME173X|ME400C|Slider SL101|\bK00F\b|\bK00C\b|\bK00E\b|\bK00L\b|TX201LA|ME176C|ME102A|\bM80TA\b|ME372CL|ME560CG|ME372CG|ME302KL| K01A | K010 | K011 | K017 | K01E |ME572C|ME103K|ME170C|ME171C|\bME70C\b|ME581C|ME581CL|ME8510C|ME181C|P01Y|PO1MA|P01Z|\bP027\b|\bP024\b|\bP00C\b`,
		// BLACKBERRYTABLET:
		`PlayBook|RIM tablet`,
		// HTCTABLET:
		...
		// ACERTABLET:
		`Android.*; \b(A100|A101|A110|A200|A210|A211|A500|A501|A510|A511|A700|A701|W500|W500P|W501|W501P|W510|W511
|W700|G100|G100W|B1-A71|B1-710|B1-711|A1-810|A1-811|A1-830)\b|W3-810|\bA3-A10\b|\bA3-A11\b|\bA3-A20\b|\bA3-A30|A3-A40`,
		...
		`Android.*\b97D\b|BNTV250A|MID-WCDMA|LogicPD Zoom2|\bA7EB\b|CatNova8|A1_07|CT704|CT1002|\bM721\b|rk30sdk|\bEVOTAB\b|M758A|ET904|ALUMIUM10|Smartfren Tab|Endeavour 1010|tablet-PC-4|Tagi Tab|\bM6pro\b|CT1020W|arc 10HD|\bTP750\b|\bQTAQZ3\b|WVT101|TM1088|KT107`,
	}
	...
	browsers = [...]string{
		...
		// CHROME:
		`\bCrMo\b|CriOS.*Mobile|Android.*Chrome/[.0-9]* (mobile)?`,
		// DOLFIN:
		`\bDolfin\b`,
		// OPERA:
		...
		`Skyfire`,
		// EDGE:
		`EdgiOS.*Mobile|mobile Safari/[.0-9]* Edge`,
		// IE:
...
type rules struct {
	...
	utilities        [len(utilities)]string
	combined         []string
}

// NewRules creates a object with all rules necessary to figure out a browser from a User Agent string
func NewRules() *rules {
	rules := &rules{namesKeys: nameToKey, phoneDevices: phoneDevices, tabletDevices: tabletDevices,
		operatingSystems: operatingSystems, browsers: browsers, utilities: utilities}
